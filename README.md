...
# Customization
In order to customize the colors / roundeness, head over to `./src/_root.scss`, and you can mess with the variables to your liking. For variable information, peek the [variables section](https://github.com/Discord-Theme-Addons/modern-channel-indicators#variables) of this README.
...
2. After installing, head over to [this link](https://raw.githubusercontent.com/Discord-Theme-Addons/modern-channel-indicators/main/src/support/ModernChannelIndiactors.user.css).
